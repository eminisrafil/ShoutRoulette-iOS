...
// OpenTokSDK
#define COCOAPODS_POD_AVAILABLE_OpenTokSDK
#define COCOAPODS_VERSION_MAJOR_OpenTokSDK 1
#define COCOAPODS_VERSION_MINOR_OpenTokSDK 4
#define COCOAPODS_VERSION_PATCH_OpenTokSDK 3
